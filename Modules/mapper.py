...
class map(object):
   ...
   def mapper(self, i):
           ...
           #print(value_agn)
           ax.pcolormesh(np.log10(value_agn+.0000000000000000000000000001), cmap='inferno')#[150:850,150:850]
           plt.colorbar(ax.pcolormesh(np.log10(value_agn+.0000000000000000000000000001), cmap='inferno'),label=r'$\log_{10}$(agn)')
